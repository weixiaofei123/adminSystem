...
var BasePlot = /*#__PURE__*/function (_React$Component) {
  ...
  (0, _createClass2["default"])(BasePlot, [{
    ...
    value: function diffData() {
      ...
      var data = this.props.data || []; // 数据只做2级浅比较
    ...
    value: function shouldReCreate() {
      var forceFit = this.props.forceFit;
      var preOptions = this.g2Instance.options;

      if (!(0, _isEqual2["default"])(preOptions.forceFit, forceFit)) {
        return true;
      }
...
function createPlot(Plot, name) {
  ...
  var Com = /*#__PURE__*/_react["default"].forwardRef(function (props, ref) {
    ...
    return /*#__PURE__*/_react["default"].createElement(_ErrorBoundary["default"], null, /*#__PURE__*/_react["default"].createElement(BxPlot // API 统一
    , (0, _object["default"])({
      // API 统一
      forceFit: autoFit,
      ref: ref,
      // react 习惯
      title: (0, _plotTools.visibleHelper)(title),
      // react 习惯
      description: (0, _plotTools.visibleHelper)(description)
    }, realCfg, {
      PlotClass: Plot
    })));
  });

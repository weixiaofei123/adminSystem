...
var ChartHelper = /*#__PURE__*/function () {
  ...
  (0, _createClass2["default"])(ChartHelper, [{
    ...
    value: function createInstance(config) {
      this.chart = new _core.Chart(config);
    ...
    value: function shouldReCreateInstance(newConfig) {
      ...
      var unCompareProps = [].concat((0, _toConsumableArray2["default"])(_constant.REACT_PIVATE_PROPS), ['width', 'height', 'container', '_container', '_interactions', 'placeholder', /^on/, /^\_on/]);
    ...
    value: function update(props) {
      ...
      this.chart.scale(options.scale); // 交互 interactions

...
var statistic_1 = tslib_1.__importDefault(require("./statistic"));
...
var RingStatistic = /** @class */ (function (_super) {
    ...
    RingStatistic.prototype.triggerOn = function () {
        ...
        this.view.on("interval:" + triggerOnEvent, util_1.debounce(function (e) {
        ...
        this.view.on("interval:" + triggerOffEvent, util_1.debounce(function () {
    ...
    RingStatistic.prototype.getTotalValue = function () {
        ...
        util_1.each(this.plot.options.data, function (item) {

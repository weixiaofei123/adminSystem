    ...
    PieLayer.prototype.processData = function (data) {
        ...
        if (allZero) {
            return data.map(function (item) {
                var _a;
                return (tslib_1.__assign(tslib_1.__assign({}, item), (_a = {}, _a[key] = typeof item[key] === 'string' ? Number.parseFloat(item[key]) : item[key], _a[percentageField] = 1 / data.length, _a)));
            });
        }
        return data.map(function (item) {
            var _a;

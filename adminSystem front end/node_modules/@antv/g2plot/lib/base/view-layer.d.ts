import { View, Geometry } from '../dependents';
...
export default abstract class ViewLayer<T extends ViewLayerConfig = ViewLayerConfig> extends Layer<T> {
    ...
    /** 画布重绘 */
    repaint(): void;
    getScaleByField(field: string): import("@antv/scale").Scale;
    ...
    protected isLimitInPlot(): boolean;

...
import { Options, AttributeOption, AdjustOption, LabelOption, MappingDatum, Element, Datum, _ORIGIN } from '../dependents';
...
export declare type Formatter = (text: string, item: any, idx: number) => string;
...
export declare type Axis = ICatAxis | IValueAxis | ITimeAxis;
export interface Label {
    visible?: boolean;
    type?: string;
    formatter?: (text: Maybe<string | number>, item: {
        [_ORIGIN]: Datum;
        mappingDatum: MappingDatum;
        mappingDatumIndex: number;
        element: Element;
        elementIndex: number;
    }, idx: number, ...extras: any[]) => string;
...
export declare type LegendPosition = 'left-top' | 'left-center' | 'left-bottom' | 'right-top' | 'right-center' | 'right-bottom' | 'top-left' | 'top-center' | 'top-right' | 'bottom-left' | 'bottom-center' | 'bottom-right';
...
export declare type G2Config = Options;
...
export declare type IInteractionConfig = {
    [field: string]: any;
};
